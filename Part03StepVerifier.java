 ...
 * @see <a href="https://tech.io/playgrounds/929/reactive-programming-with-reactor-3/StepVerifier">StepVerifier Question Desc</a>
 */
...
//========================================================================================
	...
	void expectFooBarError(Flux<String> flux) {
		StepVerifier.create(flux).expectNext("foo","bar").verifyErrorMessage(null);
	}
